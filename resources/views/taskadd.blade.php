...
@section('content')
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-user"></i><strong>Create</strong> Task<br>
            </h1>
        </div>
    </div>
    ...
    <div class="bloc">
        ...
        <body>
            <div class="block">
                ...
                <form id="clickable-wizard" action="{{ route('taskstore', ['id' => $project->id]) }}" method="post"
                    ...
                    <div id="clickable-first" class="step ui-formwizard-content" style="display: block;">
                            ...
                            <div class="col-xs-12">
                                <ul class="nav nav-pills nav-justified clickable-steps">
                                    ...
                                    <li><a href="javascript:void(0)" data-gotostep="clickable-second"><strong>2.
                                                Choose a Personnel Agent</strong></a></li>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="col-md-9">
                                    <p class="form-control-static" id="ProjectName" name="ProjectName">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="title">Title of the task</label>
                            <div class="col-md-5">
                                <input type="text" id="title" name="name" class="form-control ui-wizard-content"
                                    value="{{ old('name') }}">
                            </div>
                        </div>
                    ...
                    <div id="clickable-second" class="step ui-formwizard-content" style="display: none;">
                        ...
                        <!-- END Step Info -->
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="clientsearch">Enter a Personnel Name</label>
                            <div class="col-md-5">
                                <input type="text" id="clientsearch" name="personnell"
                            ...
                            <div class="col-xs-12">
                                <ul class="nav nav-pills nav-justified clickable-steps">
                                    ...
                                    <li><a href="javascript:void(0)" data-gotostep="clickable-second"><i
                                                class="fa fa-check"></i> <strong>2. Choose a personnel agent</strong></a>
                                    </li>
                                    <li class="active"><a href="javascript:void(0)"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea name="Description" rows="6" class="form-control ui-wizard-content"
                                    placeholder="Anything about this project ?" disabled="disabled"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
